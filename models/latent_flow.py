...
class LatentFlowModel(BaseModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        2. Run flow matching on the latents (predicts vector field z1 - z0).
        Returns (pred_flow, target_flow) both shaped (B, 4, h, w).
        """
        x0 = x.to(self.device)
        if self.renormalise:
    ...
    def sample(
        ...
        **kwargs,
        ...
        2. Integrate the flow ODE in latent space to produce clean latents.
