...
class SimpleUNet(nn.Module):
    ...
    def __init__(
        self, in_channels=1, base_channels=64, channel_mults=(1, 2, 4), time_emb_dim=128
    ):
        super().__init__()
        ...
        for mult in channel_mults:
            ...
            self.encs.append(ResidualConv(ch, out_ch, time_emb_dim=time_emb_dim))
            self.downs.append(
        ...
        # Bottleneck
        self.mid1 = ResidualConv(ch, ch, time_emb_dim=time_emb_dim)
        self.mid2 = ResidualConv(ch, ch, time_emb_dim=time_emb_dim)
        ...
        for mult in rev_mults:
            ...
            self.decs.append(
                ResidualConv(out_ch * 2, out_ch, time_emb_dim=time_emb_dim)
            )
            ch = out_ch
